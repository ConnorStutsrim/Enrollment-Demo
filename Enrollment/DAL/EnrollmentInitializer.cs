...
namespace Enrollment.DAL
{
    ...
    {
        public static void Initializer(EnrollmentContext context)
        {
            ...
            if (!context.OccupationCodes.Any())
            {
            ...
            if (!context.EmployerOccupationCodes.Any())
            {
            ...
            if (!context.WizardProgresses.Any())
            {
