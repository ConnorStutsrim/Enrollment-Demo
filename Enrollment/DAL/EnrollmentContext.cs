...
namespace Enrollment.DAL
{
    ...
    {
        public EnrollmentContext() : base("DefaultConnection") {}
        ...
        public void SetWizardProgress(string actionResult)
        {
        ...
        public void AddParticipant(Person person, Address address, int stateID)
        {
            AddPersonAddress(person, address, stateID);
            Participant participant = new Participant
            { 
                Person = person, WizardProgress = new WizardProgress { ActionResult = "" },
                IdentityID = Guid.Parse(HttpContext.Current.User.Identity.GetUserId()) 
            };
